...
local a = Instance.new("LocalScript");a.Name='DJ Board'

local b = Instance.new("LocalScript");b.Name='Dex V3'

local c = Instance.new("LocalScript");c.Name='Grab Knife V4'

local d = Instance.new("LocalScript");c.Name='Mr Spy V2'

local e = Instance.new("LocalScript");c.Name='Infinite Yield FE'

local f = Instance.new("LocalScript");c.Name='Unjailbreak X'

local scripts = {a,b,c,d,e,f}
