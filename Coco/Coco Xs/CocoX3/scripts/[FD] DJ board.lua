...
newSound("GTA San Andreas Theme", "1334164244")
newSound("Despacito 2 (FlyingKitty)", "2054135647")
newSound("Klocuch - kruci gang", "2625049275")
newSound("Taco Hemingway - Fiji", "3397942353")
newSound("Dycha & Masno - MASNO FEST", "3057363936")
newSound("(REMIX) Rafonix - Stary Wstał", "2998602469")
newSound("TACONAFIDE - Visa", "1751685154")
newSound("Noisestorm - Crab Rave", "2834095972")
newSound("TACONAFIDE - Kryptowaluty", "1638183598")
newSound("Lil Nas X - Old Town Road", "2862170886")
newSound("czuuX - O Co Ci Chodzi", "1358691243")
newSound("chillwagon - chillwagon", "2562951877")
newSound("Taco Hemingway - Deszcz na betonie", "452833586")
newSound('Lil Pump - Esskeetit (8Bit)', '1659656053')
newSound("Avengers Infinity War - Soundtrack", "1689407690")
newSound("Golec uOrkiestra - Ściernisko", "1369849205")
newSound("Darude - Sandstorm", "142401311")
newSound("Dynoro, Gigi D'Agostino - In My Mind", "2241489803")
newSound('USSR (remixed) national anthem', '1858315572')
newSound('Kubańczyk feat. Kamerzysta - Pegaz', '3032905190')
newSound('Kamerzysta - Piękna i Bestia', "2978430358")
newSound('Foster the People - Pumped Up Kicks', '2694148776')
newSound('TACONAFIDE - Tamagotchi', '1928340366')
newSound('Qbik - 4 Pory Roku', '1075343693')
newSound('Alan Walker - Darkside (Remix)', '2157579658')
