-- Made By DukyBG (don't use russian cyrilic here k)
-- edit by ravenring
-- Instances:
...
Credit.Text = "GUI - DukyBG, Scripts - some dudes in v3rm"
...
GiveAllPerks.Text = "Give all gamepasses"
