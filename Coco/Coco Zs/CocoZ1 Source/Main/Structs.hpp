...
struct DrawingAPI_Shape_Quad : public DrawingAPI_Shape {
	DrawingAPI_Vector2 PointA;
	DrawingAPI_Vector2 PointB;
	DrawingAPI_Vector2 PointC;
	DrawingAPI_Vector2 PointD;
	DrawingAPI_Vector2 Position;
	DrawingAPI_Vector2 Size;
	DrawingAPI_Colour3 Colour;
	float Thickness = 16; //16 by default
